...
if (typeof importScripts === 'function') {
  // Use CDN workbox for dev mode or when bundling isn't processed
  importScripts('https://storage.googleapis.com/workbox-cdn/releases/6.4.1/workbox-sw.js');
}

// In production, VitePWA will inject self.__WB_MANIFEST here.
// In dev, we skip it since the bundle isn't ready.
